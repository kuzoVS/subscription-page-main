...
import classes from './subscription-info-cards-minimal-dark.module.css'
        ...
        <Box className={classes.cardItem}>
            <Group gap="xs" wrap="nowrap">
                ...
                <Stack gap={2} style={{ minWidth: 0, flex: 1 }}>
                    ...
                    <Text c="white" className={classes.value} fw={500} size="sm">
                        {value}
                    </Text>
                </Stack>
            </Group>
...
export const SubscriptionInfoCardsMinimalDarkWidget = ({ isMobile: _ }: IProps) => {
